...
void URPM_WebBrowser::SetupBrowser(const FReadyPlayerWebBrowserResponse& Response)
{
	BindBrowserToObject();
...
void URPM_WebBrowser::BindBrowserToObject()
{
	if (!WebLinkObject) {
...
TSharedRef<SWidget> URPM_WebBrowser::RebuildWidget()
{
